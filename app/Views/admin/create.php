    ...
    <div class="card">
        ...
        <div class="card-body">
            ...
            <form method="post" action="<?= base_url('admin/store') ?>">
                ...
                <div class="form-group">
                    <label for="no_telp">release_date</label>
                    <input type="date" class="form-control" id="release_date" name="release_date" value="<?= old('release_date') ?>" />
                </div>

                <div class="form-group">
                    <label for="no_telp">duration_minutes</label>
                    <input type="integer" class="form-control" id="duration_minutes" name="duration_minutes" value="<?= old('duration_minutes') ?>" />
                </div>

                <div class="form-group">
                    <label for="no_telp">harga</label>
                    <input type="integer" class="form-control" id="harga" name="harga" value="<?= old('harga') ?>" />
                </div>
