  ...
  <header class="nav-top-bar">
    ...
    <div class="card">
        ...
        <div class="card-body">
            ...
            <?php endif; ?>
            <a href="<?= base_url('/admin/create'); ?>" class="btn btn-primary">Tambah</a>
            <a href="<?= base_url('/admin/riwayat'); ?>" class="btn btn-primary">Riwayat</a>
            <hr />
            <table class="table table-bordered">
                ...
                ?>
                    <tr>
                        <td><?= $no++; ?></td>
                        <td><a href="<?= base_url("/dashboard/detail/$row->title"); ?>"><button type="button"><?= $row->title; ?></button></a></td>
                        <td><?= $row->duration_minutes; ?></td>
                        <td><?= $row->description; ?></td>
                        <td><?= $row->harga; ?></td>
                        <td>
                            <a title="Edit" href="<?= base_url("/admin/edit/$row->id"); ?>" class="btn btn-info">Edit</a>
