...
.synopsis {
  ...
  color: #333;
    ...
    .main-content {
      display: flex;
      justify-content: center; /* Untuk menengahkan elemen */
      align-items: center;
  ...
  <header class="nav-top-bar">
    ...
    <h2>Total Belanja</h2>
            <hr />
                ...
                ?>
            <div class="input-box">
            <input type="text" id="nama" placeholder="Nama Lengkap" style="width: 519px; height: 30px; margin-bottom: 10px; border-radius: 50px; text-align: center;">
            <br>
            </div>
            <div class="input-box2">
            <input type="text" id="nama" placeholder="No Telpon" style="width: 519px; height: 30px; margin-bottom: 10px; border-radius: 50px; text-align: center;">
            <br>
            </div>
        </div>
        <a href="<?= base_url("/dashboard/disc"); ?>">
        <div class="input-box3">
            <span class="disc-text">disc</span>
        </div>
        </a>
        <a href="<?= base_url("/dashboard/detail/bayar/payment/$harga"); ?>">
        <div class="input-box4">
            <span class="disc-text2">Payment</span>
        </div>
        </a>
</div>
