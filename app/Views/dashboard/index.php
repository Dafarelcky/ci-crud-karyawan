    ...
    <div class="main-content">
                ...
                ?>
                        ...
                        <div class="movie-card">
                            <a href="<?= base_url("/dashboard/detail/$row->title"); ?>">
                                <img src="https://i.pinimg.com/564x/99/f8/70/99f8702093bd74454c4636a33f558c4a.jpg" alt="Movie 1 Poster" width="150">
                            </a>
                                <div class="movie-details">
                                    <div class="movie-title"><?= $row->title; ?></div>
                                    <div class="release-date"><?= $row->release_date; ?></div>
                                    <div class="duration">Duration: <?= $row->duration_minutes; ?></div>
                                    <p>Price: <?= $row->harga; ?></p>
                                    <div class="synopsis">
